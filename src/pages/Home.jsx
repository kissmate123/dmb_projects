...
const Home = () => {
  return (
    <div>
      ...
      <div className="tartalom2">
        <h2 className="title">The Pixel Realms története</h2>
      </div>
      <div className="tartalom1">
        {/* TÖRTÉNET */}
        <div className="tartalom-wrapper">
          <h3>1. fejezet – A támadás</h3>

          <p>
            Nyugalmas délelőtt a város piacterén. (Alap mozgás tutorial)
          </p>
          <p>
            Borien beszél <strong>Mirával</strong>, a pékkel (HP és gyógyítás bemutatása), majd <strong> Ariccal</strong>, a város kovácsával fegyverzet és páncél felszerelése.
          </p>
          <p>
          ...
          <p>
            Borien kiugrik az ablakon és áttör a városon. (harci tutorial)
          </p>
          <p>
          ...
          <div className="fejezet1-kep">
            <img src="/assets/images/page_back.png" alt="Háttérkép" />
          </div>
